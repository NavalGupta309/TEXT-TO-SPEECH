...
#TOP FRAME
Top_frame=Frame(root,bg="white",width=900,height=150)
Top_frame.place(x=0,y=0)

Logo=PhotoImage(file="speaker-logo.png")
Label(Top_frame,image=Logo,bg="white").place(x=10,y=5)

Label(Top_frame,text="TEXT TO SPEECH",font="arial 20 bold",bg="white",fg="black").place(x=200,y=60)


text_area=Text(root,font="Robote 20",bg="white",relief=GROOVE,wrap=WORD)
text_area.place(x=10,y=175,width=500,height=250)
